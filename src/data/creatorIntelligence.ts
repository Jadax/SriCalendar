...
export const TRENDS: Trend[] = [
  ...
  { id: 'w-gaming-2', niche: 'gaming', region: 'world', title: 'The silent buff nobody mentions', hook: 'This silent change is why the meta feels different.', angle: 'meta breakdown', format: 'clip breakdown', momentum: 71, direction: 'peaking', virality: 65, play: 'Patch-analysis content rides patch-day searches.', hashtags: ['metachanges', 'gameupdate', 'gamingnews'] },
  { id: 'w-lifestyle-1', niche: 'lifestyle', region: 'world', title: 'The 6am routine that finally stuck', hook: 'The 6am routine that finally stuck (it is not what you think).', angle: 'realistic habits', format: 'routine vlog', momentum: 79, direction: 'rising', virality: 72, play: 'Honest-routine content outperforms perfect-morning fantasies.', hashtags: ['morningroutine', 'habits', 'selfimprovement'] },
  ...
  { id: 'af-travel-2', niche: 'travel', region: 'africa', title: 'Why creators move to Accra', hook: 'Why Accra is the African city creators are moving to.', angle: 'city guide', format: 'city guide', momentum: 75, direction: 'rising', virality: 68, play: 'Relocation content rides the digital-nomad wave.', hashtags: ['accra', 'digitalnomad', 'africatech'] },
