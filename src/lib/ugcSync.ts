...
export async function flushPendingUgc(userId: string): Promise<void> {
  ...
  for (const table of ['content_ideas', 'scripts', 'hook_library', 'production_board', 'brand_deals', 'invoices', 'media_kit', 'knowledge_base', 'analytics', 'content_pillars', 'goals', 'production_checklists', 'collaborations', 'content_results', 'ugc_deliverables', 'outreach'] as const) {
